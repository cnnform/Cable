...
/**
 * 毫米波雷达管理对象 biz_millimeter_wave_radar
 * 
 * @author yhjz
 * @date 2022-11-06
 */
public class BizMillimeterWaveRadar extends BaseEntity
{
    ...
    /** 指向：摄像头正前方与正北方的夹角（现在没有使用） */
    @Excel(name = "指向：摄像头正前方与正北方的夹角", readConverterExp = "现=在没有使用")
    private Long arrow;
    ...
    /** 补角：云台0度与正北方的夹角，顺时针为正 */
    @Excel(name = "补角：云台0度与正北方的夹角，顺时针为正")
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("alertRegions", getAlertRegions())
