...
public class EmailUtil {
    ...
    public static final String myEmailAccount = "";
    ...
    public static void sendEmail(String emailAccount,String subject, String content) throws Exception {
        if (StringUtils.isEmpty(emailAccount)) {
            log.error("email地址为空，不能发送");
            return;
        }
        ...
        // 3. 创建一封邮件即邮件对象
        MimeMessage message = createMimeMessage(session, myEmailAccount, emailAccount, subject, content);
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String subject, String content) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "线缆监控", "UTF-8"));
